...
// Toda pantalla lleva 3 capas: la foto de la sucursal, un velo verde
// oscuro para que el texto respire, y encima el contenido. Si la foto
// no carga, queda el degradado de marca del documento como respaldo.
function baseDoc(contenido) {
  return {
    type: 'APL',
    version: '2024.3',
    theme: 'dark',
...
function buildPantallaTexto(texto, hint) {
  ...
  return baseDoc({
    ...
    items: [
      ...
      {
        type: 'Text',
        text: hint || 'Di "ayuda" para ver qué puedo hacer',
        fontFamily: FUENTE_TITULOS,
        fontStyle: 'italic',
        fontSize: "${@viewportProfile == @hubRoundSmall ? '14dp' : '20dp'}",
        color: COLORES.doradoClaro,
